                ...
                <div className="screen">
                    ...
                    <div className="hyperContent">
                        <div className="intro" id="Intro">
                            <p>
                                Defining Cinematography: The Visual Language of Film
                        ...
                        <div className="toolbox" id="toolbox">
                            <p>
                                The world of film isn't just actors and scripts; it's a symphony of light, shadow, and
                                movement orchestrated by the skilled hands of the cinematographer. To achieve their vision,
                        ...
                        <div className="movingPictures" id="movingPictures">
                            <p>
                                Title: Moving Pictures: Unravelling the Art of Camera Movements in Cinematography
                                Introduction:
                        ...
                        <div className="composition" id="composition">
                            <p>
                                Title: Visual Harmony: The Art of Cinematic Composition
                                Introduction:
                        ...
                        <div className="shotSize" id="shotSize">
                            <p>
                                Title: Shot Size and Meaning: Crafting Cinematic Narratives through Visual Scale
                                Introduction:
                        ...
                        <div className="powerThrough" id="powerThrough">
                            <p>
                                Power through Perspective: Exploring Cinematography's Impact on Power Dynamics and
                                Emotions
                        ...
                        <div className="lightningTechniques" id="lightningTechniques">
                            <p>
                                Cinematography and the Three-Point Lighting Setup
                        ...
                        <div className="advancedLightining" id="advancedLightining">
                            <p>
                                Cinematography is a crucial aspect of filmmaking that involves the art and science of
                        ...
                        <div className="colorTheory" id="colorTheory">
                            <p>
                                The Psychology of Color in Cinematography
                        ...
                        <div className="caseStudy" id="caseStudy">
                            <p>
                                Case Study: "Tumbbad" - A Cinematic Odyssey
                                Introduction:
                                ...
                                4. Critical Acclaim and Global Recognition:
                                ...
                                existential dread, leaving the audience haunted by the consequences of the characters' actions 2.Visual Aesthetics:
                                Cinematography:
                                ...
                                overarching theme.
                                <img src="" alt="" srcset="" />
                                3. Impact on the Crime Thriller Genre:
